...
from .views import (
    ...
    clear_drawn_polygon_assets, clear_manual_point_assets,
    clear_all_manual_assets,
    get_manual_assets, delete_manual_asset,
...
urlpatterns = [
    ...
    path('api/assets/clear-drawn-polygons/', clear_drawn_polygon_assets, name='clear_drawn_polygon_assets'),
    path('api/assets/clear-manual-points/', clear_manual_point_assets, name='clear_manual_point_assets'),
    path('api/assets/clear-manual-all/', clear_all_manual_assets, name='clear_all_manual_assets'),
    path('api/assets/manual/', get_manual_assets, name='get_manual_assets'),
    path('api/assets/manual/delete/', delete_manual_asset, name='delete_manual_asset'),
